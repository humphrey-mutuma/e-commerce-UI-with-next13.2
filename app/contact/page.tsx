...
const Contact: NextPage = () => {
  ...
  const handleFormData = (e: FormEvent) => {
    ...
    if (!name || !email || !subject || !message) {
      ToastifyFailure("All fields are required!");
      return;
    }
    try {
      axios
  ...
  return (
    <main className="max-w-5xl mx-auto ">
      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
          ...
          <p className="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">
            Contact us today and find out how we can help each other. Use the
            contact form or the details below to get in touch.
          </p>
          <form onSubmit={handleFormData} className="space-y-8">
            <div>
              <label
                htmlFor="name"
            ...
            {AllFieldsFilled ? (
              <button
                ...
                className="py-3 w-full px-5 bg-red-900 text-sm font-medium text-center text-white rounded-lg  sm:w-fit hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800"
              >
                Send message
              </button>
            ) : (
              <button
                aria-label="send message"
                className="py-3 w-full px-5 bg-slate-500 text-sm font-medium text-center text-white rounded-lg  sm:w-fit hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800"
              >
                Send message
              </button>
            )}
      ...
      {/*  */}
      <article className="w-full px-4 mb-12  flex  sm:items-center justify-evenly flex-wrap  ">
        <article className="mb-8 flex w-full max-w-[370px]">
          <div className="bg-red text-red mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
            <svg
              width="24"
              height="26"
              viewBox="0 0 24 26"
          ...
          <div className="w-full">
            ...
            <p className="text-body-color text-base">(+254)700 111 222</p>
          </div>
        </article>
        <article className="mb-8 flex w-full max-w-[370px]">
          <div className="bg-red text-red mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
          ...
          <div className="w-full">
            ...
            <p className="text-body-color text-base">info@sneakers.co.ke</p>
          </div>
        </article>
      </article>
      {/*  */}
